...
Last synchronized from confirmed workspace evidence and 2.1.2 native email FormType regression: 15 September 2026.

Current release: `2.1.2` (`v2.1.2`). Declared support: Mautic 5.x, 6.x, 7.x; PHP >=8.1 <8.5.

| Mautic | Status | Confirmed scope |
| --- | --- | --- |
| 5.2.10 | ✓ | Fresh container, integration and form checks, 6 Sep 2026 |
| 6.0.9 | ✓ | Fresh container, integration and form checks, 6 Sep 2026; 2.1.2 DB-free checks including inactive existing-action preservation, inactive empty-form hiding, post-confirmation owner-email dispatch and unchecked-owner-email skip, plus runtime check that primary DOI email buttons are not plugin-copied legacy markup, 15 Sep 2026 |
